describe("ShoppingCart", function(){
  ...
  beforeEach(function(){
    ...
    blueSuedeShoes = jasmine.objectContaining({ productName: "Suede Shoes, Blue",
                category: "Women\’s Footwear", price: 270 , quantity: 10});
    birdPrintDress = jasmine.objectContaining({ productName: "Bird Print Dress, Black",
                category: "Women\’s Formalwear", price: 270 , quantity: 10});
    goldButtonCardigan = jasmine.objectContaining({ productName: "Gold Button Cardigan, Black",
                category: "Women’s Casualwear", price: 167 , quantity: 6});
    flipFlopRed = jasmine.objectContaining({ productName: "Flip Flops, Red",
                category: "Men\'s Footwear", price: 19 , quantity: 6});
    cottonShortsRed= jasmine.objectContaining({ productName: "Cotton Shorts, Medium Red",
                category: "Women\’s Casualwear", price: 30 , quantity: 5});
  });
